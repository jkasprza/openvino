...
#if OV_GPU_WITH_SPIRV
#    define OV_GPU_CREATE_INSTANCE_SPIRV(...) EXPAND(CREATE_INSTANCE(__VA_ARGS__))
#else
#    define OV_GPU_CREATE_INSTANCE_SPIRV(...)
#endif
